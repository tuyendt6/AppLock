...
public class KidModeAdapter2 extends ArrayAdapter<MyApplication> implements OnCheckedChangeListener {
	public static List<MyApplication> mListApplication;
	private LayoutInflater inflate;
	public KidModeAdapter2(Context context, int resource, List<MyApplication> objects) {
